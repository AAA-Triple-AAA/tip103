...
by a list of strings collection. You need to display these prints on a 
single wall in a 2D array format that meets the following criteria:
...
them. Note that the 2D array can have a different number of elements on each row.
